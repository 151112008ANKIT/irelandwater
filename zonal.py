from osgeo import gdal  # raster management
from osgeo import ogr  # vector managment
...
fn_raster = "newdata/AAB/sen.png"
fn_zones = "newdata/AAB/fianl.shp"
print("aaaa")
